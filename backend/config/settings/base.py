...
LOCAL_APPS = ["platforma.platforma.apps.PlatformaConfig"]
...
# MIGRATIONS
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {"sites": "platforma.contrib.sites.migrations"}
...
STATIC_ROOT = str(APPS_DIR.path("shared/static"))
...
REDIRECT_PREFIX = env("REDIRECT_PREFIX", default="/")
